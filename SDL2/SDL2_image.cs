...
namespace SDL2
{
	...
	{
		[FieldOffset(0)]  public uint flags;               /**< Read-only */
		[FieldOffset(8)]  public IntPtr pixelFormat;    /**< Read-only */
		[FieldOffset(16)] public int w;
		[FieldOffset(20)] public int h;                   /**< Read-only */
		[FieldOffset(24)] public int pitch;                  /**< Read-only */
		[FieldOffset(32)] public IntPtr pixels;               /**< Read-write */
		/** Application data associated with the surface */
		[FieldOffset(40)] public IntPtr userdata;             /**< Read-write */
		/** information needed for surfaces requiring locks */
		[FieldOffset(48)] public int locked;                 /**< Read-only */
		[FieldOffset(56)] public IntPtr lock_data;            /**< Read-only */
		/** clipping information */
		[FieldOffset(64)] public SDL_Rect clip_rect;         /**< Read-only */
		/** info for fast blit mapping to other surfaces */
		[FieldOffset(80)] public IntPtr blitmap;    /**< Private */
		/** Reference count -- used when freeing surface */
		[FieldOffset(88)] public int refcount;               /**< Read-mostly */
	}
	...
	public unsafe struct SDL_PixelFormat
	{
		...
		[FieldOffset(8)]  public IntPtr palette;
		[FieldOffset(16)] public byte BitsPerPixel;
		[FieldOffset(17)] public byte BytesPerPixel;
		[FieldOffset(18)] public fixed byte padding[2];
		[FieldOffset(20)] public uint Rmask;
		[FieldOffset(24)] public uint Gmask;
		[FieldOffset(28)] public uint Bmask;
		[FieldOffset(32)] public uint Amask;
		[FieldOffset(36)] public byte Rloss;
		[FieldOffset(37)] public byte Gloss;
		[FieldOffset(38)] public byte Bloss;
		[FieldOffset(39)] public byte Aloss;
		[FieldOffset(40)] public byte Rshift;
		[FieldOffset(41)] public byte Gshift;
		[FieldOffset(42)] public byte Bshift;
		[FieldOffset(43)] public byte Ashift;
		[FieldOffset(44)] public int refcount;
		[FieldOffset(48)] public IntPtr next;
	}

	[StructLayout(LayoutKind.Explicit, Size = 24)]
	public struct SDL_Palette
	{
		[FieldOffset(0)]  public int ncolors;
		[FieldOffset(8)]  public IntPtr colors;
